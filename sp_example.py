...
K = E*I/L**3 * sparse.csc_matrix([[12,6*L,-12,6*L],[6*L,4*L**2,-6*L,2*L**2],[-12,-6*L,12,-6*L],[6*L,2*L**2,-6*L,4*L**2]])
M = Rho*A*L/420 * sparse.csc_matrix([[156,22*L,54,-13*L],[22*L,4*L**2,13*L,-3*L**2],[54,13*L,156,-22*L],[-13*L,-3*L**2,-22*L,4*L**2]])

# %% Perform eigen
rl_val, rl_vect = hyperdual2.real_eigs(K.a,M.a,2)
val,vect = hyperdual2.eigs(K,M,2)
# %% Validation
# Real
...
print(f"Performing eigenvalue comparison")
